...
all_cmpd_ref_areas <- read_csv("intermediates/NFEX_diss_clean_areas.csv") %>%
...
gbt_cmpd_ratios <- read_csv("intermediates/NFEX_diss_clean_areas.csv") %>%
  select("filename", "compound_name", "area", "cmpd_type", "samp_type") %>%
...
guanine_cmpd_ratios <- read_csv("intermediates/NFEX_diss_clean_areas.csv") %>%
  select("filename", "compound_name", "area", "cmpd_type", "samp_type") %>%
...
homarine_cmpd_ratios <- read_csv("intermediates/NFEX_diss_clean_areas.csv") %>%
  select("filename", "compound_name", "area", "cmpd_type", "samp_type") %>%
...
glutamic_cmpd_ratios <- read_csv("intermediates/NFEX_diss_clean_areas.csv") %>%
  select("filename", "compound_name", "area", "cmpd_type", "samp_type") %>%
...
glutamine_cmpd_ratios <- read_csv("intermediates/NFEX_diss_clean_areas.csv") %>%
  select("filename", "compound_name", "area", "cmpd_type", "samp_type") %>%
...
write_csv(cmpd_cncs, "intermediates/NFEX_diss_cmpd_cncs.csv")
