...
#Writing them out
write_csv(clean_areas, "intermediates/NFEX_parti_clean_areas.csv")
write_csv(IS_list, "intermediates/NFEX_parti_IS_list.csv")
write_csv(standards_list, "intermediates/NFEX_parti_standards_list.csv")
